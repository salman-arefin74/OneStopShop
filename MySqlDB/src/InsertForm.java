...
public class InsertForm extends javax.swing.JFrame {
    ...
    Connection connect;
    public InsertForm(Connection c) {
        this.connect = c;
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String user_type= jTextField2.getText().toString();
        ...
        insertData(id,user_type,name,email,password);
    }//GEN-LAST:event_jButton1ActionPerformed

    public void insertData(String id, String user_type, String name, String email, String password){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InsertForm(null).setVisible(true);
            }
        });
    }
